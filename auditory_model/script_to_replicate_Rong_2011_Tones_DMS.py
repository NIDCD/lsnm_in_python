#!/usr/bin/python
#
# The following script replicates the results of Rong et al (2011), Tones during DMS
#
# Type of stimuli: Tones
# We have one condition: Delayed Match to Sample (DMS)
#
...
#
# The attention parameter in all trials is constant at 0.2
#
...
script_params = [0.01, 0.2, 0.0, 1.0, 0.0, [], []]
...
def tone_02(modules, script_params):
    ...
    """
    presents a tone to neural network using the given parameters
