#!/usr/bin/python
#
# Script created on July 15 2017
#
...
#
# Each task block is composed of 3 PV (passive viewing=DMS w low att) trials in the following order:
# MATCH, MISMATCH, MATCH.
# The attention parameter in the PV trials is 0.15 (low attention) and the attention parameter in the rest
# blocks is 0.05
#
...
script_params = [0.05, 0.15, 0.05, 0.7, 0.02, [], []]
