...
#
# There are 4 DMS trials and 4 control trials for each of six levels of attention
#
# We have a total of 48 trials ([4 dms + 4 ctl] * 6 levels of attention)
#
# The number of timesteps in each trial is 1100 = 5.5 seconds
#
# The total number of timesteps is 52800 = 264 seconds
#
# Each block is composed of 4 trials = 4400 timesteps = 22 seconds
#
# We have a total of 12 blocks, 6 dms and 6 ctl (insterspersed)
#
# However, please note that there is an 'DUMMY' block at the beginning of this script.
# Thus, we have 4400 extra time steps. However, we are not counting that dummy block
# above, as we are going to discard it when we do the analysis.
#
...
simulation_events = {        
    ...
    ################### FIRST BLOCK IS A DUMMY BLOCK ######################
    ################### HAVING A DUMMY BLOCK IS USEFUL ####################
    ################### FOR ANALYZING BOLD FMRI, AS WE ####################
    ################### WOULD BE ABLE TO DISCARD A WHOLE ##################
    ################### BLOCK WITHOUT LOSING ANY ACTUAL ###################
    ################### EXPERIMENT BLOCK ##################################
    
    # DO NOTHING FOR THE FIRST 4400 TIMESTEPS
