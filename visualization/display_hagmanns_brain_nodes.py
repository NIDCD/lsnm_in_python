...
fs_module = mlab.points3d(fs[0],fs[1],fs[2],color=(1, 0, 0),scale_factor = 10.)
d1_module = mlab.points3d(d1[0],d1[1],d1[2],color=(1, 0, 0),scale_factor = 10.)
d2_module = mlab.points3d(d2[0],d2[1],d2[2],color=(1, 0, 0),scale_factor = 10.)
fr_module = mlab.points3d(fr[0],fr[1],fr[2],color=(1, 0, 0),scale_factor = 10.)
